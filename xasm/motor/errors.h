...
#ifndef XASM_MOTOR_ERRORS_H_INCLUDED_
#define XASM_MOTOR_ERRORS_H_INCLUDED_
...
typedef enum {
	...
	ERROR_ELF_LOAD_ZERO,
	ERROR_NOT_IN_STRUCTURE_SCOPE,
	ERROR_MODIFY_INTERNAL_SYMBOL,
	ERROR_SECTION_SIZE_EXCEEDS_PAGE
} EError;

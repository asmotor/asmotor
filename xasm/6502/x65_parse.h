...
#define MODE_6502                                                                                                                  \
	(MODE_NONE | MODE_IMM | MODE_ZP | MODE_ZP_X | MODE_ZP_Y | MODE_ABS | MODE_ABS_X | MODE_ABS_Y | MODE_IND_ZP_X | MODE_IND_ZP_Y | \
	 MODE_A | MODE_IND_ABS)
...
#define MODE_65816                                                                                                              \
	(MODE_65C02 | MODE_816_DISP_S | MODE_816_LONG_IND_ZP | MODE_816_LONG_ABS | MODE_816_IND_DISP_S_Y | MODE_816_LONG_IND_ZP_Y | \
	 MODE_816_LONG_ABS_X | MODE_816_LONG_IND_ABS)
#define MODE_4510                                                                                                            \
	(MODE_6502 | MODE_IND_ABS_X | MODE_ZP_ABS | MODE_BIT_ZP | MODE_BIT_ZP_ABS | MODE_4510_IND_ZP_Z | MODE_816_IND_DISP_S_Y | \
	 MODE_4510_ABS_X | MODE_4510_ABS_Y)

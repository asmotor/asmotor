...
#define MODE_ALL_INDEXED                                                                                                    \
	(MODE_INDEXED_R_5BIT | MODE_INDEXED_R_INC1 | MODE_INDEXED_R_INC2 | MODE_INDEXED_R_DEC1 | MODE_INDEXED_R_DEC2 |          \
	 MODE_INDEXED_R | MODE_INDEXED_R_A | MODE_INDEXED_R_B | MODE_INDEXED_R_8BIT | MODE_INDEXED_R_16BIT | MODE_INDEXED_R_D | \
	 MODE_INDEXED_PC_8BIT | MODE_INDEXED_PC_16BIT | MODE_EXTENDED_INDIRECT | MODE_INDIRECT_MODIFIER)
#define MODE_ALLOWED_INDIRECT                                                                                       \
	(MODE_ADDRESS | MODE_EXTENDED | MODE_INDEXED_R_INC2 | MODE_INDEXED_R_DEC2 | MODE_INDEXED_R | MODE_INDEXED_R_A | \
	 MODE_INDEXED_R_B | MODE_INDEXED_R_8BIT | MODE_INDEXED_R_16BIT | MODE_INDEXED_R_D | MODE_INDEXED_PC_8BIT |      \
	 MODE_INDEXED_PC_16BIT)
